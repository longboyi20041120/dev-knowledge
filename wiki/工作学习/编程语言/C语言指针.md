...
- [[wiki/工作学习/编程语言/C语言基础|C 语言基础]] — 内存管理、结构体、static/extern/const 完整用法
- [[wiki/工作学习/数据结构与算法/数组与双指针|数组与双指针]] — 算法中的"指针"思想（双指针、快慢指针、滑动窗口）
- [[wiki/工作学习/计算机基础/操作系统|操作系统]] — 虚拟内存、分页、inode 中的指针
