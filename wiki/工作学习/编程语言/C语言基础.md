...
> **详见**：[[wiki/工作学习/编程语言/C语言指针|C 语言指针]] — 更完整的指针详解（内存模型、void*、指针与结构体、指针数组 vs 数组指针、const、常见笔试题）
...
- [[wiki/工作学习/数据结构与算法/数组与双指针|数组与双指针]] — 算法中大量用到指针思想
- [[wiki/工作学习/数据结构与算法/哈希表与查找|哈希表与查找]] — C 语言中可以用结构体+链表实现
- [[wiki/工作学习/工程基础/Git基础与协作|Git 基础与协作]] — 管理 C 语言项目
- [[wiki/工作学习/编程语言/Java基础|Java 基础]] — Java 没有指针但有引用，对比学习
- [[wiki/工作学习/编程语言/Python基础|Python 基础]] — Python 底层是 C 写的，CPython 解释器
